                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            @endif
                            <form action="{{ route("dashboard.places.update", $place->id) }}" enctype="multipart/form-data" method="POST">
                                @csrf
                                @method("PUT")
                                <div class="row">
                                    <div class="col-md-8 mx-auto">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" id="title" name="title" placeholder="Write title">{{ $place->title }}</textarea>
                                        </div>

                                        <div class="form-group">
                                            <label for="description">Description</label>
                                            <textarea class="form-control" id="description" name="description" placeholder="Write description">{{ $place->description }}</textarea>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <img id="imagepreview" class="img-fluid img-thumbnail mt-3" src="{{ asset("uploads/journey/".$place->file_name) }}"/>
                                        </div>
