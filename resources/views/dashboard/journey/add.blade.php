                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            @endif
                            <form action="{{ route("dashboard.journies.store") }}" enctype="multipart/form-data" method="POST">
                                @csrf
                                <div class="row">
