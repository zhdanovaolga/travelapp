                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">New Journey</h3>
                        </div>
                        <div class="card-body">
                            @if ($errors->any())
                            ...
                            @endif
                            <form action="{{ route("dashboard.expenses.store", $journeyId) }}" enctype="multipart/form-data" method="POST">
                                @csrf
                                <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8 mx-auto">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" id="cost" name="cost" placeholder="Write cost">{{ old('cost') }}</textarea>
                                        </div>
                                    </div>
