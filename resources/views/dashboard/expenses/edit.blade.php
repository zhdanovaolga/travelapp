                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            @endif
                            <form action="{{ route("dashboard.expenses.update", $expense->id) }}" enctype="multipart/form-data" method="POST">
                                @csrf
                                @method("PUT")
                                <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" id="cost" name="cost" placeholder="Write cost">{{ $expense->cost }}</textarea>
                                        </div>

                                        <div class="form-group">
                                            <label for="description">Description</label>
                                            <textarea class="form-control" id="description" name="description" placeholder="Write description">{{ $expense->description }}</textarea>
                                        </div>
